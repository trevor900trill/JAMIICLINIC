...
function CaseDetailPage() {
    ...
    const caseIdStr = Array.isArray(id) ? id[0] : id;
            ...
            <Card>
                <CardHeader>
                    <div className="flex justify-between items-start">
                        ...
                        <Button variant="outline" onClick={() => router.push(`/dashboard/medical-cases`)}>
                            <ArrowLeft className="mr-2 h-4 w-4" />
                            Back to Cases
                        </Button>
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                    <Card>
                        ...
                        <CardContent>
                            {caseDetails.medical_records && caseDetails.medical_records.length > 0 ? (
                                <div className="space-y-4">
                                    {caseDetails.medical_records.map(record => (
